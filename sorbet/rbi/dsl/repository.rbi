...
class Repository
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Repository` class because it declared `has_many :pull_request_reviews`.
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_owner?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_owner?(from: T.unsafe(nil), to: T.unsafe(nil)); end
